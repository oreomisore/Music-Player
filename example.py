...
for zone in os.listdir('/usr/bin'):
    fileList.insert(tkinter.END, zone)  # .END will insert each item at the end of the list
...
rbValue = tkinter.IntVar()  # were creating 3 radio buttons that share the same variable aso that only one can be selected at a time.
rbValue.set(2)
#  Radio buttons
